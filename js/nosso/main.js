...
/*  Owl Carousel Clientes */
  ...
  if(window.location.href.indexOf('produtos/piteira') == -1 && window.location.href.indexOf('produtos/la-revolucion') == -1){
    owlCarousel.on("changed.owl.carousel", e => {
  
        if(!$(".owl-slide-animated").hasClass("is-transitioned")){
