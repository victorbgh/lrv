...
<head>
    ...
    <script>
     ...
     <meta name="description" content="LRV Brasil, o tabaco teve origem nos vales orientais dos Andes Bolivianos..." />
     ...
     <meta property="og:title" content="Historia do tabaco - LRV Brasil" />
     <meta property="og:description" content="LRV Brasil, o tabaco teve origem nos vales orientais dos Andes Bolivianos..." />
     <meta property="og:image" content="<?php echo url_site;?>img/lrv.png" />
     <meta property="og:url" content="<?php echo url_site;?>historia-do-tabaco.php" />
     ...
     <title>Historia do tabaco - LRV Brasil</title>
...
<body>
  <header id="historia-do-tabaco" data-stellar-background-ratio="0.5" class="overlay-historia-do-tabaco">
    <div class="historiaDoTabaco">
    <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo" style="height: 70px;">
        <div class="container">
          <div class="navbar-header">
            <a href="index.html" class="navbar-brand"><img class="img-fulid" src="img/lrv.png" alt="LRV Logo" height="auto" width="auto"></a>
