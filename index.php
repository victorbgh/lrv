...
<body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo" style="height: 70px;">
            <div class="container">
                <div class="navbar-header">
                    <a href="<?php echo url_site;?>" class="navbar-brand"><img class="img-fulid"
                            src="<?php echo url_site;?>img/lrv.png" alt="LRV Logo" alt="LRV Logo" height="auto"
                            width="auto"></a>
                ...
                <div class="collapse navbar-collapse" id="main-navbar">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <div class="social-icons " style="margin-top: auto; margin-bottom: auto;">
                            <ul>
                                <li class="facebook"><a href="https://www.facebook.com/larevolucionn.br/"
                                        target="_blank" title="Acessar facebook da LRV"><i
                                            class="fa fa-facebook"></i></a></li>
                                <li class="google-plus"><a href="https://www.instagram.com/lrvbrasil/" target="_blank"
                                        title="Acessar instagram da LRV"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                        </div>
                    </ul>
                    ...
                    <div id="lang_selector" class="language-dropdown">
                        <label for="toggle" class="lang-flag lang-pt" title="Selecione a linguagem"
                            style="margin-top: 44px; margin-left: 30px;">
            ...
            <div class="side-menu-wrapper">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a class="page-scroll lang" href="#culturaTabaco" rel="nofollow" lang="es">Cultura del
                            tabaco</a>
                    </li>
                    <li>
                    ...
                    <ul style="display: inline-flex; margin-top: 15px;">
                        <li class="facebook"><a href="https://www.facebook.com/larevolucionn.br/"
                                style="background: #ddd0 !important; margin: 10px; color: #f1f1f1;" target="_blank"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li class="google-plus"><a href="https://www.instagram.com/lrvbrasil/"
                                style="background: #ddd0 !important; margin: 10px; color: #f1f1f1;" target="_blank"><i
                    ...
                    <div class="container">
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-10 col-md-6 static">
                                <div class="owl-slide-text titulo-header">
                                    <h1 style="color: #000" class="owl-slide-animated owl-slide-title">CHEGARAM AS PITEIRAS DE VIDRO <img
                                            class="img-fulid" src="<?php echo url_site;?>img/lrv.png"
                                            alt="LRV Logo" alt="LRV Logo" height="auto" width="40%"
                                            style="width: 40% !important;"></h1>
                                    <p style="color: #000" class="owl-slide-animated owl-slide-subtitle mb-3" lang="pt">Você já conhece as
                                        piteiras de vidro LRV? Foram desenvolvidas com a finalidade de auxiliar na
                                        redução de danos e preservação do meio ambiente além de ressaltar o sabor.</p>
                                    <p style="color: #000" class="owl-slide-animated owl-slide-subtitle mb-3" lang="es">¿Ya conoces las
                                        boquillas de cristal LRV? Fueron desarrollados con el propósito de ayudar en la
                                        reducción de daños y preservación del medio ambiente además de resaltar el
                                        sabor.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="overlay-carousel vertical-center">
                    <div class="container">
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-10 col-md-6 static">
                                <div class="owl-slide-text titulo-header">
                                    <h2 style="color: #000" class="owl-slide-animated owl-slide-title">TABACO <img
                                            src="<?php echo url_site;?>img/LA REVOLUCION PNG.png"
                                            alt="LRV BRASIL TABACO" width="60%" height="auto"></h2>
                                    <p style="color: #000" class="owl-slide-animated owl-slide-subtitle mb-3 bold" lang="pt">O VERDADEIRO
                                        DESTALADO</p>
                                    <p style="color: #000" class="owl-slide-animated owl-slide-subtitle mb-3 bold" lang="es">EL VERDADERO
                                        INDEPENDIENTE</p>
                                </div>
                            </div>
                        </div>
    ...
    <section id="services" class="section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title wow fadeIn" data-wow-duration="600ms" data-wow-delay="0.5s"><span
                        lang="pt">SOBRE A LRV BRASIL</span> <span lang="es">ACERCA DE LRV BRASIL</span></h2>
                ...
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.6s">
                    <span lang="pt">Tudo começou quando três revolucionários se encantaram pela cultura do tabaco para
                        enrolar na capital do país.</span>
                    <span lang="es">Todo comenzó cuando tres revolucionarios quedaron encantados con la cultura del
                        tabaco para rodar en la capital del país.</span>

                </p>

                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.7s">
                    <span lang="pt">Com isso, viram a carência de um produto qualitativo no mercado, gerando incentivo
                        para empreender, que sempre foi um sonho em comum.</span>
                    <span lang="es">Con esto, vieron la falta de un producto cualitativo en el mercado, generando un
                        incentivo para emprender, que siempre ha sido un sueño común.</span>

                </p>
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.8s">
                    <span lang="pt">
                        Isso os motivou a realizarem uma jornada do Centro ao Sul do país, região onde a cultura do
                        plantio de tabaco ocorre há séculos.
                        Essa aventura lhes proporcionou a oportunidade de <b class="bold">degustar</b>
                        diversos tipos e cortes de fumo.
                    </span>
                    <span lang="es">
                        Esto los motivó a emprender un viaje desde el centro hacia el sur del país, una región donde la
                        cultura de la siembra de tabaco se lleva a cabo durante siglos.
                        Esta aventura les brindó la oportunidad de <b class="bold">degustar</b> diferentes tipos y
                        cortes de tabaco.
                    </span>
                ...
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.9s">
                    <span lang="pt">
                        Após um longo processo de seleção, foi escolhido o tabaco mais qualitativo do tipo Golden
                        Virgínia para lançarmos o nosso primeiro produto:
                        o <b class="bold">La Revolución</b>, que possui como característica especial ser destalado à
                        mão, tornando-o único.
                    </span>
                    <span lang="es">
                        Luego de un largo proceso de selección, se eligió el tabaco tipo Golden Virgínia más cualitativo
                        para lanzar nuestro
                        primer producto: <b class="bold">La Revolución</b>, que tiene la característica especial de ser
                        cortado a mano, lo que lo hace único.
                    </span>

                </p>
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="1.0s">
                    <span lang="pt">
                        Desde o início, sempre houve o sonho de revolucionar o mercado com produtos da mais alta
                        qualidade, proporcionando experiências singulares aos
                        entusiastas da cultura.
                    </span>
                    <span lang="es">
                        Desde el principio, siempre ha existido el sueño de revolucionar el mercado con productos de la
                        más alta calidad,
                ...
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="1.1s">
                    <span lang="pt">
                        Durante toda essa jornada, houveram diversos desafios para encontrar o carro-chefe, pois não
                        faltava ambição para possuir o melhor tabaco do mercado.
                        Desde o princípio, houve o compromisso de legalizar todos os produtos, visto que muitas marcas
                        comercializam produtos ilegais e que podem ser danosos
                        aos consumidores. Isso mostra a preocupação da empresa com os clientes, pois sem a legalização,
                        não há como o órgão regulatório saber quais as
                        substâncias que o fumo possui.
                    </span>
                    <span lang="es">
                        A lo largo de este viaje, hubo varios desafíos para encontrar el buque insignia, ya que no faltó
                        la ambición de poseer
                        el mejor tabaco del mercado. Desde el principio, hubo un compromiso de legalizar todos los
                        productos, ya que muchas
                        marcas comercializan productos ilegales que pueden ser perjudiciales para los consumidores. Esto
                        muestra la preocupación
                        de la empresa con los clientes, porque sin legalización, no hay forma de que el organismo
                        regulador sepa qué sustancias
                        tiene el tabaco.
                    </span>
                </p>
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="1.2s">
                    <span lang="pt">
                        A onça foi designada como símbolo da LRV por ser um dos animais mais imponentes e fortes da
                        fauna brasileira. <i>Vimos</i>, assim, grande identificação com
                        nossos ideais, pois <i>pretendemos</i> liderar o mercado nacional.
                    </span>
                    <span lang="es">
                        El jaguar fue designado como símbolo de la LRV porque es uno de los animales más imponentes y
                        fuertes de la fauna brasileña.
                        <i>Así</i>, vimos una gran identificación con nuestros ideales, ya que lideramos el mercado
                        nacional.
                    </span>
                ...
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="1.3s">
                    <span lang="pt">
                        Além disso, a onça representa nossas raízes, que jamais serão esquecidas, afinal, desejamos
                        expor a cara do nosso país
                        nessa jornada de crescimento.
                    </span>
                    <span lang="es">
                        Además, el jaguar representa nuestras raíces, que nunca se olvidarán, después de todo, queremos
                        exponer el rostro de
                ...
                <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="1.4s">
                    <span lang="pt">
                        Somos ambiciosos e temos a pretensão de aumentar o nosso portfólio de produtos, gerando
                        experiências únicas e sempre acompanhado dos nossos três pilares:
                        Qualidade, Legalidade e Transparência.
                    </span>
                    <span lang="es">
                        Somos ambiciosos y pretendemos incrementar nuestro portafolio de productos, generando
                        experiencias únicas y siempre
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="item-boxes wow fadeInDown" data-wow-delay="0.4s">
                        ...
                        <p>
                            <span lang="pt">Proporcionar experiências inigualáveis, lutando pela igualdade e inclusão
                                social.</span>
                            <span lang="es">Brindar experiencias inigualables, luchando por la igualdad y la inclusión
                                social.</span>
                        </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="item-boxes wow fadeInDown" data-wow-delay="0.7s">
                        ...
                        <p>
                            <span lang="pt">Sermos reconhecidos mundialmente pela qualidade e confiabilidade dos nossos
                                produtos.</span>
                            <span lang="es">Ser reconocidos mundialmente por la calidad y confiabilidad de nuestros
                                productos.</span>
                        </p>
                    </div>
                </div>
        ...
        <div class=" ">
            <div class="container ">
                <div class="section-header section" style="margin-bottom: 0px !important;">
                    <h1 class="section-title wow fadeIn" data-wow-duration="600ms" data-wow-delay="0.4s"><span
                            lang="pt">Cultura do Tabaco</span> <span lang="es">Cultura del tabaco</span></h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 box-item">
                            <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.6s">
                                <span lang="pt">
                                    O tabaco era usado pelos indígenas em rituais religiosos com o objetivo de
                                    purificar, contemplar, proteger e fortalecer os
                                    ímpetos guerreiros. Os termos tabacum e tabaco vêm do nome de um tipo de junco
                                    vazado que era usado pelos indígenas para inalar o fumo.
                                </span>
                                <span lang="es">
                                    El tabaco era utilizado por los indígenas en rituales religiosos con el fin de
                                    purificar, contemplar, proteger y
                                    fortalecer los impulsos guerreros. Los términos tabacum y tabaco provienen del
                                    nombre de un tipo de caña hueca que usaban los indígenas para inhalar humo.
                                </span>
                            </p>
                            <p class="section-subtitle wow fadeInUp" data-wow-duration="600ms" data-wow-delay="0.6s">
                                <span lang="pt">
                                    Levado para a Europa nas navegações de Cristóvão Colombo, a rainha da França,
                                    Catarina de Médicis, passou a usar o fumo em pó para curar enxaquecas.
                                    O uso do tabaco para esta finalidade foi recomendado por Jean Nicot (vem daí o nome
                                    do seu princípio ativo, a nicotina).
                                </span>
                                <span lang="es">
                                    Llevada a Europa en los viajes de Cristóbal Colón, la reina de Francia, Catalina de
                                    Médicis, comenzó a usar
                                    tabaco en polvo para curar las migrañas. Jean Nicot recomendó el uso de tabaco para
                                    este fin (de ahí el nombre de
                                    su ingrediente activo, nicotina).
                                </span>
                            </p>
                            <a class="lrvLinkButton wow fadeInUp" data-wow-duration="600ms" data-wow-delay="0.8"
                                href="historia-do-tabaco.php"><span lang="pt">Leia mais</span> <span lang="es">Lea
                                    mas</span></a>
                        </div>
                    </div>
                </div>
    ...
    <section id="a-revolucao" class="section">
        <div class="container">
            <div class="section-header col-md-12">
                <h1 class="section-title wow fadeIn" data-wow-duration="600ms" data-wow-delay="0.3s"><span
                        lang="pt">NOSSOS PRODUTOS</span> <span lang="es">NUESTROS PRODUCTOS</span></h1>
                <span class="lines wow zoomIn" data-wow-delay="0.3s"></span>
                <p class="section-subtitle wow fadeInDown font-700" data-wow-duration="600ms" data-wow-delay="0.3s">
                    <span lang="pt">
                        ...
                        revolução que chegue e nos leve em sua marcha.
                        Nós mesmos somos o futuro. Nós somos a revolução.”
                    </span>
                    <span lang="es">
                        “No podemos esperar a que los tiempos cambien y cambiemos juntos, a una revolución que llegue y
                        nos lleve en su marcha.
                        Nosotros mismos somos el futuro. Somos la revolución ”.
                    </span>

                </p>
                <p class="section-subtitle wow fadeInUp font-700" data-wow-duration="600ms" data-wow-delay="0.3s">
                    Beatrice Bruteau</p>
            </div>
            ...
            <section class="hero-section">
                <div class="card-grid justify-custom">
                    <a class="card" href="produtos/la-revolucion">
                        <div class="card__background" style="background-image: url(img/tabaco2.png); background-position: right"></div>
                        <div class="card__content">
                            <!-- <p class="card__category">Category</p> -->
                            <!-- <h3 class="card__heading">Tabaco <img
                                    src="<?php echo url_site;?>img/LA REVOLUCION BRANCO.png" alt="LRV BRASIL TABACO"
                                    width="100%" height="auto"></h3> -->
                        </div>
                    </a>
                    <a class="card" href="produtos/piteira">
                        <div class="card__background" style="background-image: url(img/piteira1.png); background-position: right"></div>
                        <!-- <div class="card__content">
                            <img src="<?php echo url_site;?>img/pirteiras logo branca-01.png"
                                class="img-fluid margin-center" alt="LRV BRASIL TABACO" width="80%" height="auto">
                        </div> -->
                    </a>
                    <div>
            </section>
    ...
    <div id="testimonial" class="">
        <div class="masked ">
            <div class="container" style="padding-top: 80px; padding-bottom: 80px;">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="section-title wow fadeIn word-wrap" data-wow-duration="600ms" data-wow-delay="0.3s">
                            <span lang="pt">REGISTRO</span> <span lang="es">GRABAR</span>
                        </h1>
                        ...
                        <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.3s">
                            <span lang="pt">
                                A Agência Nacional de Vigilância Sanitária (ANVISA) é o órgão responsável pela
                                regulamentação de produtos derivados do tabaco.
                            </span>
                            <span lang="es">
                                La Agencia Nacional de Vigilancia Sanitaria (ANVISA) es el organismo responsable de la
                        ...
                        <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.4s">
                            <span lang="pt">Após o crescimento da cultura do tabaco para enrolar, fomos os precursores
                                no êxito da conquista da legalidade no Centro do país.</span>
                            <span lang="es">Luego del crecimiento de la cultura del tabaco para rodar, fuimos los
                                precursores en el éxito de la conquista de la legalidad en el centro del país.</span>
                        </p>
                        <p class="section-subtitle wow fadeInDown" data-wow-duration="600ms" data-wow-delay="0.5s">
                            <span lang="pt">Combata a ilegalidade e valorize a <b
                                    style="text-transform:uppercase">transparência</b>.</span>
    ...
    <section id="portfolios" class="section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title wow fadeIn" data-wow-duration="600ms" data-wow-delay="0.3s"><span
                        lang="pt">Galeria</span> <span lang="es">Galería</span></h2>
    ...
    <section id="encontrar" class="masked-encontrar">
        <div class="masked">
            <div class="container" style="padding: 80px 0 80px 0;">
                <div class="section-header">
                    <h1 class="section-title wow fadeIn color-white" data-wow-duration="600ms" data-wow-delay="0.5s">
                        <span lang="pt">ONDE ENCONTRAR</span> <span lang="es">DONDE ENCONTRAR</span>
                    </h1>
                    <span class="lines wow zoomIn" data-wow-delay="0.3s"></span>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="cidadeMapa" class="form-control" id="cidadeMapa"
                                style="height: auto !important;" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="tipoPontoMapa" class="form-control" id="tipoPontoMapa"
                                style="height: auto !important;" required>
                ...
                <div class="row justify-content-center" style="text-align: center;">
                    <div class="col-md-12 justify-content-center">
                        <span lang="pt">
                            <button type="button" class="btn btn-warning white-space-normal wow fadeInUp"
                                data-wow-duration="600ms" data-wow-delay="0.8" onclick="redirecionarCadPonto()">Clique
                                aqui para cadastrar seu ponto de venda</button>
                        </span>
                        <span lang="es">
                            <button type="button" class="btn btn-warning white-space-normal wow fadeInUp"
                                data-wow-duration="600ms" data-wow-delay="0.8" onclick="redirecionarCadPonto()">Registra
                                tu punto de venta</button>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <section id="contact" class="section" data-stellar-background-ratio="-0.2">
        <div class="contact-form">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title wow fadeIn" data-wow-duration="600ms" data-wow-delay="0.3s"><span
                            lang="pt">CONTATO</span> <span lang="es">CONTACTO</span></h2>
                    <span class="lines wow zoomIn" data-wow-duration="600ms" data-wow-delay="0.3s"></span>
                </div>
                        ...
                        <div class="contact-us">
                            ...
                            <div class="contact-address">
                                <p class="wow fadeInLeft" data-wow-duration="600ms" data-wow-delay="0.5s">
                                    <span lang="pt">Estamos à disposição para esclarecer dúvidas e sempre abertos à
                                        sugestões, parcerias, entre outros. Tanto para consumidores quanto
                                        para fornecedores!</span>
                                    <span lang="es">¡Estamos disponibles para responder preguntas y siempre abiertos a
                                        sugerencias!</span>
                                </p>
                                <p class="phone wow fadeInLeft" data-wow-duration="600ms" data-wow-delay="0.6s">
                                    <span lang="pt">Use o formulário ao lado para enviar a mensagem, ou se preferir, envie uma mensagem nos meios disponíveis abaixo.</span>
                                    <span lang="es">Si lo prefiere, utilice el formulario al costado para enviar el
                                        mensaje.</span>
                                </p>
                                <a class="wow fadeInLeft" title="Enviar uma mensagem por email"
                                    href="mailto:contato@larevolucionbr.com" data-wow-duration="600ms"
                                    data-wow-delay="0.7s">
                                    <i class="fa fa-envelope"></i><span> contato@lrvbrasil.com</span></a>
                                <br><br>
                                <a class="wow fadeInLeft" title="Enviar uma mensagem por email"
                                    href="https://api.whatsapp.com/send?phone=5561991310693" target="_blank"
                                    data-wow-duration="600ms" data-wow-delay="0.7s">
                                    <i class="fa fa-whatsapp "></i><span> (61) 991310693</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-duration="600ms"
                        data-wow-delay="0.5s">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" name="name"
                                                ...
                                                data-error="Por favor, digite o seu nome">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" placeholder="Seu Email" id="email" class="form-control"
                                                name="name" required data-error="Por favor, digite o seu e-mail">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-sm-8 col-xs-12">
                    <ul class="footer-links">
                        <li>
                            <a class="page-scroll" href="#home-area"><span lang="pt">Home</span> <span
                                    lang="es">Home</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#services"><span lang="pt">Sobre</span> <span lang="es">Sobre
                                    nosotros</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#culturaTabaco"><span lang="pt">Cultura do Tabaco</span> <span
                                    lang="es">Cultura del tabaco</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#a-revolucao"><span lang="pt">Produtos</span> <span
                                    lang="es">Nuestros productos</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#testimonial"><span lang="pt">Registro</span> <span
                                    lang="es">Grabar</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#portfolios"><span lang="pt">Galeria</span> <span
                                    lang="es">Galería</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#encontrar"><span lang="pt">Onde encontrar</span> <span
                                    lang="es">Donde encontrar</span></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#contact"><span lang="pt">Contato</span> <span
                                    lang="es">Contacto</span></a>
                        </li>
                    </ul>
                </div>
    ...
    <div id="laRevolucionConfirmarIdade" class="overlayConfirm">
        <div class="imagemLRV">
            <div class="overlayConfirm-content">
                <a class="" style="font-weight: bold;"><span lang="pt">VOCÊ TEM MAIS DE 18 ANOS?</span> <span
                        lang="es">¿ES MAYOR DE 18 AÑOS?</span></a>
                <div class="row commands lrv-buttons-age">
                    <button class="text-center btn btn-success" onclick="closeNav()"
                        style="margin-right: 30px; cursor: pointer; font-size: 25px;"><span lang="pt">Sim</span> <span
                            lang="es">Si</span></button>
                    <button class="text-center btn btn-danger" onclick="historyBack()"
                        style="margin-left: 30px; cursor: pointer; font-size: 25px;"><span lang="pt">Não</span> <span
                            lang="es">No</span></button>
                </div>
            </div>
        </div>
    </div>
    ...
    function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
            center: {
                lat: -15.814432199999997,
                lng: -47.888157299999996
            },
            zoom: 13
        });
                ...
                google.maps.event.addListener(marker, 'click', function(evt) {
                    ...
                    directionsService.route({
                        ...
                        function(response, status) {
                            if (status === 'OK') {
                                ...
                                for (var i = 0, len = response.routes.length; i <
                                    len; i++) {
                                    if (i === 0) {
                    ...
                    function callback(response, status) {
                        if (status == google.maps.DistanceMatrixStatus.OK) {
                            $('#distanciaPonto').val(' ');
                            $('#tempoPonto').val(' ');
                            $('#distanciaPonto').append(response.rows[0].elements[0].distance
                                .text);
