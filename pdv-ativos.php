<?php
    ...
    $sql = "SELECT * FROM pontos_venda where ponto_aprovado=1";
...
<head>
    ...
    <script>
     ...
     <meta property="og:site" content="<?php echo url_site;?>/pdv-ativos.php" />
     ...
     <meta property="og:url" content="<?php echo url_site;?>pdv-ativos.php" />
     ...
     <title>PDV Ativos - LRV Brasil</title>
  ...
  <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo" style="height: 70px; background: #000 !important;">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              <li class="nav-item">
                <a class="nav-link page-scroll" href="lista-de-pontos.php" style="color: #fff !important;">PDV Pendentes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link page-scroll active" href="pdv-ativos.php" style="color: #fff !important;">PDV Ativos</a>
              </li>
              <li class="nav-item">
              <a class="nav-link" data-toggle="modal" data-target="#exampleModalLong" href="" onclick="confirmeSair()" style="color: #fff !important;"><i class="fa fa-sign-out-alt"></i> Sair</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="side-menu-wrapper">
          ...
          <ul>
            ...
            <li><a class="page-scroll active ativo" href="pdv-ativos.php" rel="nofollow">PDV Ativos</a></li>
            <li> <a class="page-scroll" data-toggle="modal" data-target="#exampleModalLong" onclick="confirmeSair()">Sair</a></li>
          </ul>
        </div>
  ...
  <div class="">
    <div class="container box-shadow">
        <div class="heading" style="padding: 20px;">
                <h1 style="text-align: center;">PDV Ativos</h1>
                ...
                <?php if(!empty($arr_users)) { ?>
                    <?php foreach($arr_users as $user) { ?>
                        <tr>
                            ...
                            <button class="marginbutton" title="Editar Local" onclick="editarLocal(<?php echo $user['id']; ?>)">
                                    <a style="color: green;" class="fa fa-pencil"></a></button>
